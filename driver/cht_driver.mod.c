...
MODULE_ALIAS("of:N*T*Ccht_dma");
MODULE_ALIAS("of:N*T*Ccht_dmaC*");
MODULE_ALIAS("of:N*T*Cxlnx,axi-dma-mm2s-channel");
MODULE_ALIAS("of:N*T*Cxlnx,axi-dma-mm2s-channelC*");
MODULE_ALIAS("of:N*T*Cxlnx,axi-dma-s2mm-channel");
MODULE_ALIAS("of:N*T*Cxlnx,axi-dma-s2mm-channelC*");
